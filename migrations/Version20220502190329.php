 ...
 */
final class Version20220502190329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE main_sport (id INT NOT NULL, distance INT NOT NULL, elevation_gain INT DEFAULT NULL, elevation_loss INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE secondary_sport (id INT NOT NULL, PRIMARY KEY(id))');
    }
